...
exports.getVirtualTxReceiptsFromEvents = exports.getEffectiveGasPrice = exports.parseExtrinsic = exports.getTransactionIndexAndHash = exports.findEvmEvent = exports.getEvmExtrinsicIndexes = exports.getPartialTransactionReceipt = exports.getPartialLogs = exports.getPartialLog = void 0;
...
const getEffectiveGasPrice = async (evmEvent, api, blockHash, extrinsic, actualWeight) => {
    ...
    txFee = (0, utils_2.nativeToEthDecimal)(txFee, 12);
...
const getVirtualTxReceiptsFromEvents = (events, blockHash, blockNumber) => {
    const receipts = events
        .filter(utils_2.isOrphanEvmEvent)
        .map(exports.getPartialTransactionReceipt)
        .map((partialReceipt, i) => {
        const transactionHash = (0, utils_1.keccak256)([...(0, util_1.hexToU8a)(blockHash), ...(0, util_1.nToU8a)(i)]);
        const txInfo = {
            transactionIndex: 0,
            transactionHash,
            blockHash,
...
exports.getVirtualTxReceiptsFromEvents = getVirtualTxReceiptsFromEvents;
