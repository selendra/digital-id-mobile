...
var _selendra = _interopRequireDefault(require("./spec/selendra"));
...
const types = _objectSpread(_objectSpread(_objectSpread({}, _ormlTypeDefinitions.types), (0, _utils.typesFromDefs)(selendraDefs)), additionalOverride);

exports.types = types;
const rpc = (0, _utils.jsonrpcFromDefs)(selendraDefs, _objectSpread({}, _ormlTypeDefinitions.rpc));
exports.rpc = rpc;
const typesAlias = (0, _utils.typesAliasFromDefs)(selendraDefs, _objectSpread({}, _ormlTypeDefinitions.typesAlias));
...
const typesBundle = {
  spec: {
    selendra: getBundle(_selendra.default)
  }
