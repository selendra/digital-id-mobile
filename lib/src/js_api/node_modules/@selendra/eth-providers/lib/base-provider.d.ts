...
export declare abstract class BaseProvider extends AbstractProvider {
    ...
    getVirtualTxReceiptAtBlock: (hashOrNumber: number | string | Promise<string>, blockHash: string) => Promise<TransactionReceipt | null>;
    getNormalTxReceiptAtBlock: (hashOrNumber: number | string, blockHash: string) => Promise<TransactionReceipt>;
    ...
    getOrphanLogsAtBlock: (blockTag?: BlockTag | Promise<BlockTag> | undefined) => Promise<Log[]>;
