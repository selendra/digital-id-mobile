...
import 'package:digital_id/components/dialog_c.dart';
...
import 'package:digital_id/screens/import_account/body_import_acc.dart';
...
class ImportAccState extends State<ImportAcc> {
  ...
  Future<void> addAccount() async {
    ...
    Navigator.pushAndRemoveUntil(
      context, 
      Transition(child: DashboardPage(), transitionEffect: TransitionEffect.RIGHT_TO_LEFT), 
      ModalRoute.withName('/')
    );
    
  }
  
  Future<void> importAccountNAsset() async {
